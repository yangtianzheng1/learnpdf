...
import static com.example.pdflibrary.Constants.Cache.CACHE_SIZE;
...
public class PagesLoader {
    ...
    private String TAG = "PagesLoader";
    ...
    private List<RenderRange> getRenderRangeList(float firstXOffset, float firstYOffset, float lastXOffset, float lastYOffset) {
        ...
        for (int page = firstPage; page <= lastPage; page++) {
            ...
            LogUtils.logD(TAG, " rowHeight " +  rowHeight + " colWidth " + colWidth);
            ...
            if (pdfView.isSwipeVertical()) {
                ...
                LogUtils.logD(TAG, " leftTop " +  range.leftTop.toString() + " rightBottom " + range.rightBottom.toString());
            } else {
    ...
    private void loadVisible() {
        ...
        LogUtils.logD(TAG, " firstXOffset " + firstXOffset + " firstYOffset " + firstYOffset);

        LogUtils.logD(TAG, " lastXOffset " + lastXOffset + " lastYOffset " + lastYOffset);
