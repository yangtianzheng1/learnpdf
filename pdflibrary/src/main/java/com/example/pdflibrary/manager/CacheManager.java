...
import static com.example.pdflibrary.Constants.Cache.THUMBNAILS_CACHE_SIZE;
...
public class CacheManager {
    ...
    public boolean upPartIfContained(int page, RectF pageRelativeBounds, int toOrder) {
        LogUtils.logD(TAG, " normal " + pageRelativeBounds.toString());
    ...
    public boolean containsThumbnail(int page, RectF pageRelativeBounds) {
        LogUtils.logD(TAG, " containsThumbnail " + pageRelativeBounds.toString());
