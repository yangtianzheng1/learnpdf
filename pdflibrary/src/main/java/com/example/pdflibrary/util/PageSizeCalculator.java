...
public class PageSizeCalculator {
    ...
    private Constants.FitPolicy fitPolicy;
    ...
    public PageSizeCalculator(Constants.FitPolicy fitPolicy, Size originalMaxWidthPageSize, Size originalMaxHeightPageSize,
